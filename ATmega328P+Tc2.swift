...
extension ATmega328P.Tc2: TimerPeripheral {
  /// Provides access to the current counter value.
  @inlinable @inline(__always) public static var counter: UInt8 {
    @inlinable @inline(__always) get { .init(Self.`tcnt2`.registerValue) }
    @inlinable @inline(__always) set { Self.`tcnt2`.registerValue = .init(truncatingIfNeeded: newValue) }
  }

  /// Determines the clock source for the timer.
  @inlinable @inline(__always) public internal(set) static var clock: ClockSelect3Bit {
    @inlinable @inline(__always) get { .init(bitfieldValue: Self.`tccr2b`.`cs2`.bitfieldValue) }
    set { Self.`tccr2b`.`cs2` = .init(bitfieldValue: newValue.bitfieldValue) }
  }

  /// The waveform generation mode.
  @inlinable @inline(__always) public static var waveformGenerationMode: UInt8 {
    @inlinable @inline(__always) get {
      let wgm = Self.`tccr2a`.`wgm2`.bitfieldValue
      let wgm2 = Self.`tccr2b`.`wgm22`.bitfieldValue
      return wgm2 << 2 | wgm
    }
    @inlinable @inline(__always) set {
      Self.`tccr2a`.`wgm2` = .init(bitfieldValue: newValue & 0b11)
      Self.`tccr2b`.`wgm22` = .init(bitfieldValue: (newValue >> 2) & 0b1)
    }
  }
  ...
  @inlinable @inline(__always) public static func configureModeNormal(clock: ClockSelect3Bit) {
...
extension ATmega328P.Tc2: TimerPhaseCorrectPWM8BitConfigurable {
  ...
  @inlinable @inline(__always) public static func configureModePhaseCorrectPWM8Bit(clock: ClockSelect3Bit) {
...
extension ATmega328P.Tc2: TimerPhaseCorrectPWMWithTopAtChannelAConfigurable {
  ...
  /// - Parameter clock: The clock source to use for the timer.
  @inlinable @inline(__always) public static func configureModePhaseCorrectPWMWithTopAtChannelA(clock: ClockSelect3Bit) {
...
extension ATmega328P.Tc2: TimerFastPWM8BitConfigurable {
  ...
  /// counting from `0` again. If an interrupt is enabled for the overflow, the interrupt will be triggered as well.
  /// - Parameter clock: The clock source to use for the timer.
  @inlinable @inline(__always) public static func configureModeFastPWM8Bit(clock: ClockSelect3Bit) {
...
extension ATmega328P.Tc2: TimerFastPWMWithTopAtChannelAConfigurable {
  ...
  /// overflow, the interrupt will be triggered as well.
  /// - Parameter clock: The clock source to use for the timer.
  @inlinable @inline(__always) public static func configureModeFastPWMWithTopAtChannelA(clock: ClockSelect3Bit) {
...
extension ATmega328P.Tc2: TimerWithChannelA {
  /// The "A" channel of the ``ATmega328P/Tc2`` peripheral.
  public enum ChannelA: Timer8BitChannel {
    /// The ``TimerPeripheral`` type that owns this channel.
    public typealias Timer = ATmega328P.Tc2
    ...
    @inlinable @inline(__always) public static var compareValue: Counter {
      @inlinable @inline(__always) get { .init(Timer.`ocr2a`.registerValue) }
      @inlinable @inline(__always) set { Timer.`ocr2a` = .init(registerValue: .init(newValue)) }
    }
  }
}

extension ATmega328P.Tc2.ChannelA: TimerChannelWithPin {
  ...
  @inlinable @inline(__always) public static var outputPinEffect: OutputComparePinEffect {
    @inlinable @inline(__always) get { .init(bitfieldValue: Timer.`tccr2a`.`com2a`.bitfieldValue) }
    @inlinable @inline(__always) set { Timer.`tccr2a`.`com2a` = .init(bitfieldValue: newValue.bitfieldValue) }
  }
  ...
  @inlinable @inline(__always) public static func forceCompareMatch() -> Bool {
    ...
    Timer.`tccr2b`.`foc2a` = .init(bitfieldValue: 1)
    return true
  }
}

extension ATmega328P.Tc2.ChannelA: HasOutputComparePin {
  /// The ``OutputComparePin`` type for this channel.
  public enum OutputCompare: TimerOutputComparePin {
    public typealias Channel = ATmega328P.Tc2.ChannelA
    ...
    /// The pin number
    @inlinable @inline(__always) public static var portPin: UInt8 { 3 }

  }
}

extension ATmega328P.Tc2.Signals.Oca: HasOutputComparePin {
  /// The ``OutputComparePin`` for ``ATmega328P/Tc2``.``ATmega328P/Tc2/ChannelA``.
  public typealias OutputCompare = ATmega328P.Tc2.ChannelA.OutputCompare
}

extension ATmega328P.Tc2.ChannelA: HasPWM8BitPin {
...
extension ATmega328P.Tc2.Signals.Oca: HasPWM8BitPin {
  /// The  8-bit ``PWMPin`` for ``ATmega328P/Tc2``.``ATmega328P/Tc2/ChannelA``.
  public typealias PWM8 = ATmega328P.Tc2.ChannelA.PWM8
}
...
extension ATmega328P.Tc2 {
  ...
  @inlinable @inline(__always) public static func configureModeCTC(clock: ClockSelect3Bit, top: ChannelA.Counter) {
...
extension ATmega328P.Tc2: TimerWithChannelB {
  /// The "B" channel of the ``ATmega328P/Tc2`` peripheral.
  public enum ChannelB: Timer8BitChannel {
    ...
    /// This value is used as a comparison value against the ``timer``'s counter value.
    @inlinable @inline(__always) public static var compareValue: Counter {
      @inlinable @inline(__always) get { .init(Timer.`ocr2b`.registerValue) }
      @inlinable @inline(__always) set { Timer.`ocr2b` = .init(registerValue: .init(newValue)) }
    }
  }
}

extension ATmega328P.Tc2.ChannelB: TimerChannelWithPin {
  /// Determines the effect of the ``compareValue`` on the ``timer``'s output pin.
  @inlinable @inline(__always) public static var outputPinEffect: OutputComparePinEffect {
    @inlinable @inline(__always) get { .init(bitfieldValue: Timer.`tccr2a`.`com2b`.bitfieldValue) }
    @inlinable @inline(__always) set { Timer.`tccr2a`.`com2b` = .init(bitfieldValue: newValue.bitfieldValue) }
  }
  ...
  @inlinable @inline(__always) public static func forceCompareMatch() -> Bool {
    guard Timer.isModeNormal || Timer.isModeCTC else { return false }
    Timer.`tccr2b`.`foc2b` = .init(bitfieldValue: 1)
    return true
  }
}

extension ATmega328P.Tc2.ChannelB: HasOutputComparePin {
  /// The ``OutputComparePin`` type for this channel.
  public enum OutputCompare: TimerOutputComparePin {
    public typealias Channel = ATmega328P.Tc2.ChannelB
...
extension ATmega328P.Tc2.Signals.Ocb: HasOutputComparePin {
  /// The ``OutputComparePin`` for ``ATmega328P/Tc2``.``ATmega328P/Tc2/ChannelB``.
  public typealias OutputCompare = ATmega328P.Tc2.ChannelB.OutputCompare
}

extension ATmega328P.Tc2.ChannelB: HasPWM8BitPin {
  /// The 8-bit ``PWMPin`` type for this channel.
  public enum PWM8: TimerPWM8BitPin, HasPWM8BitPin {
    /// The Channel type.
    public typealias Channel = ATmega328P.Tc2.ChannelB
...
extension ATmega328P.Tc2.Signals.Ocb: HasPWM8BitPin {
  /// The  8-bit ``PWMPin`` for ``ATmega328P/Tc2``.``ATmega328P/Tc2/ChannelB``.
  public typealias PWM8 = ATmega328P.Tc2.ChannelB.PWM8
}
